...
model.Qg = Var(model.GB, model.t, within=NonNegativeReals, bounds=Qg_bounds)
...
model.Eq1 = Constraint(model.i, model.i, model.t, rule=eq1)
model.Eq2 = Constraint(model.i, model.i, model.t, rule=eq2)
model.Eq3 = Constraint(model.i, model.t, rule=eq3)
model.Eq4 = Constraint(model.i, model.t, rule=eq4)
model.Eq5 = Objective(rule=eq5, sense=minimize)
model.Eq6 = Constraint(model.GB, model.t, rule=eq6)
model.Eq7 = Constraint(model.GB, model.t, rule=eq7)
